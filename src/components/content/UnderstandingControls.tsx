  ...
  return (
    <section className="prose prose-gray max-w-none">
      ...
      <ul className="list-disc pl-6 space-y-3">
        <li>
          <strong>MBB Beam:</strong> Named after Messerschmitt-Bolkow-Blohm (a German aerospace 
        ...
        <li>
          <strong>Cantilever:</strong> A beam fixed on one side with a load on the other—like 
        ...
        <li>
          <strong>Bridge:</strong> Supported at both ends with weight distributed across the 
      ...
      <ul className="list-disc pl-6 space-y-2">
        <li>
          <strong>Lower values (20-30%):</strong> Very lightweight designs with thin, delicate 
          structures. These are more efficient but may be harder to manufacture.
        </li>
        <li>
          <strong>Medium values (40-50%):</strong> A good balance between weight savings and 
          manufacturability. This is often used in practice.
        </li>
        <li>
          <strong>Higher values (60-80%):</strong> More robust designs with thicker members. 
      ...
      <ul className="list-disc pl-6 space-y-2">
        <li>
          <strong>60x20:</strong> Fastest computation, good for quick exploration. The shapes 
          may look a bit blocky.
        </li>
        <li>
          <strong>90x30:</strong> A good balance between speed and detail.
        </li>
        <li>
          <strong>120x40:</strong> Highest detail, but takes longer to compute. Use this to 
      ...
      <ol className="list-decimal pl-6 space-y-3">
        <li>
          <strong>Early iterations are messy:</strong> At first, the design looks noisy with 
          lots of gray areas. This is normal—the algorithm is exploring different possibilities.
        </li>
        <li>
          <strong>Structures crystallize:</strong> Around iteration 20-40, you&apos;ll see clear 
          structural members start to form as the gray areas resolve to black or white.
        </li>
        <li>
          <strong>Final refinement:</strong> The last iterations make small adjustments to 
          member thicknesses and remove any remaining inefficient material.
        </li>
        <li>
          <strong>Diagonal patterns:</strong> Notice how forces &quot;flow&quot; through the structure 
