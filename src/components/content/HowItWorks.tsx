  ...
  return (
    <section className="prose prose-gray max-w-none">
      ...
      <ul className="list-disc pl-6 space-y-2">
        <li>
          <strong>Black areas</strong> represent solid material—these regions are working hard 
          to carry the load.
        </li>
        <li>
          <strong>White areas</strong> represent empty space—material has been removed because 
          it wasn&apos;t contributing to the structure&apos;s strength.
        </li>
        <li>
          <strong>Gray areas</strong> are intermediate—the algorithm is still deciding whether 
      ...
      <p>
        Click the <strong>&quot;Stress&quot;</strong> button to see <em>why</em> material is being 
        removed. This view shows the strain energy in each element:
      </p>
      <ul className="list-disc pl-6 space-y-2">
        <li>
          <strong>Blue areas</strong> have low strain energy—they&apos;re not doing much work, 
          so the algorithm removes material here.
        </li>
        <li>
          <strong>Red areas</strong> have high strain energy—they&apos;re working hard to 
          resist the load, so material is kept or added here.
        </li>
        <li>
          <strong>White areas</strong> are in between.
        </li>
      </ul>
      ...
      <ul className="list-disc pl-6 space-y-2">
        <li>
          <strong>Blue triangles</strong> show where the structure is supported (fixed in place).
        </li>
        <li>
          <strong>Red arrows</strong> show where forces are applied.
        </li>
      </ul>
    </section>
  );
