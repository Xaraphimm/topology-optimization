  ...
  return (
    <section className="prose prose-gray max-w-none">
      <p className="text-lg text-gray-600 leading-relaxed">
        ...
        strong structures using the least amount of material. <strong>Topology optimization</strong> is 
      ...
      <ul className="list-disc pl-6 space-y-2">
        <li>
          <strong>Aerospace:</strong> Aircraft and spacecraft need to be as light as possible 
          while remaining strong. Topology-optimized parts can reduce weight by 40% or more.
        </li>
        <li>
          <strong>Automotive:</strong> Lighter cars use less fuel. Many car manufacturers use 
          topology optimization for suspension components, brackets, and structural parts.
        </li>
        <li>
          <strong>3D Printing:</strong> Traditional manufacturing has limits on what shapes you 
        ...
        <li>
          <strong>Medical Implants:</strong> Hip replacements and other implants can be designed 
